    ...
    e.fn.fullpage = function (l) {
        ...
        function Oe() {
            ...
            if (!l.autoScrolling || l.scrollBar) {
                var o = ne.scrollTop(), i = Be(o), a = 0, r = o + ne.height() / 2, s = lt.height() - ne.height() === o, c = t.querySelectorAll(y);
        ...
        function $n(e) {
            var n = o.round(e);
            if (l.scrollBar || !l.autoScrolling) vt.scrollTop(n); else if (l.css3) {
